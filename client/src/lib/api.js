...
export const authApi = {
  login: (email, password, rememberMe = false) => request('POST', '/auth/login', { email, password, rememberMe }),
  register: (data) => request('POST', '/auth/register', data),
  forgotPassword: (email) => request('POST', '/auth/forgot-password', { email }),
  resetPassword: (token, password) => request('POST', '/auth/reset-password', { token, password }),
  getPendingUsers: () => request('GET', '/auth/pending-users'),
  approveUser: (id, role) => request('PATCH', `/auth/approve-user/${id}`, { role }),
  rejectUser: (id) => request('PATCH', `/auth/reject-user/${id}`),
