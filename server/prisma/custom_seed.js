...
async function main() {
  ...
  const admins = await Promise.all([
    prisma.user.create({ data: { name: 'Admin One', email: 'admin1@cafe.com', password: defaultPassword, role: 'ADMIN' } }),
    prisma.user.create({ data: { name: 'Admin Two', email: 'admin2@cafe.com', password: defaultPassword, role: 'ADMIN' } }),
  ]);
  
  const employees = await Promise.all([
    prisma.user.create({ data: { name: 'Employee One', email: 'emp1@cafe.com', password: defaultPassword, role: 'EMPLOYEE' } }),
    prisma.user.create({ data: { name: 'Employee Two', email: 'emp2@cafe.com', password: defaultPassword, role: 'EMPLOYEE' } }),
    prisma.user.create({ data: { name: 'Employee Three', email: 'emp3@cafe.com', password: defaultPassword, role: 'EMPLOYEE' } }),
  ]);
